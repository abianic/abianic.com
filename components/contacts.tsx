const Contacts = () => {
  ...
  return (
    <div id="contacts" className="relative isolate bg-white">
        ...
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto  lg:mx-0 ">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Estamos aquí para ayudarte y responder cualquier pregunta que puedas tener. Esperamos
              con interés conversar contigo.
            </p>
            <ul className="mt-12 flex flex-wrap items-center gap-x-12 gap-y-6 pb-24 lg:gap-x-24">
              {contactMethods.map((item, idx) => (
                <li key={idx}>
                  <h4 className="text-lg font-medium text-gray-600">{item.title}</h4>
